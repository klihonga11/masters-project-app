...
public class SuggestedRecipesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private ArrayList<RecipeModel> data;

    public SuggestedRecipesAdapter(Context context, ArrayList<RecipeModel> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_suggested_recipes, parent, false);
